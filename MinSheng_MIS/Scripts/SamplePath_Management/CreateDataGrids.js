...
const AEDGOptions = {
    ...
    columns: [[
        ...
        { field: 'InternalCode', title: 'RFID內碼', align: 'center', width: 360, sortable: true },
        { field: 'ExternalCode', title: 'RFID外碼', align: 'center', width: 130, sortable: true },
        { field: 'RFIDName', title: 'RFID名稱', align: 'center', width: 280, sortable: true },
        { field: 'RFIDArea', title: 'RFID棟別', align: 'center', width: 140, sortable: true },
        { field: 'RFIDFloor', title: 'RFID樓層', align: 'center', width: 120, sortable: true },
        { field: 'RFIDMemo', title: 'RFID備註', align: 'center', width: 200, sortable: true },
        ...
        { field: 'Model', title: '型號', align: 'center', width: 180, sortable: true },
